...
public class HealthPrivacyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Sol Holo · Health-Datenschutz");
        ...
        policy.setText(
            "Sol Holo verwendet Health Connect ausschließlich lesend und nur, " +
            ...
            "werden.\n\n" +
            "Sol Holo schreibt, verändert oder löscht keine Health-Daten. Es gibt " +
            ...
            "Gesundheitswerte dienen der persönlichen Übersicht. Sol Holo stellt " +
